...
## Introduction
Dashboard UI is a React.js application 

## Features
- About : An overview of my metrics
...
1. Clone the repository: `git clone https://github.com/sohan03/DashboardUI`
2. Navigate to the project directory: `cd DashboardUI`
